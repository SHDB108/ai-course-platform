...
public class PaperServiceImpl implements PaperService {
    ...
    private final QuizPaperMapper pMapper;
    private final QuizPaperQuestionMapper pqMapper;
    private final QuestionMapper questionMapper;
    private final QuestionOptionMapper optionMapper;

    @Autowired
    public PaperServiceImpl(QuizPaperMapper pMapper, QuizPaperQuestionMapper pqMapper, QuestionMapper questionMapper, QuestionOptionMapper optionMapper) {
        this.pMapper = pMapper;
        this.pqMapper = pqMapper;
